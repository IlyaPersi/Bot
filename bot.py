...
• Skillbox — {COMMISSIONS['skillbox']} 
• SkillFactory — {COMMISSIONS['skillfactory']}  
• GeekBrains — {COMMISSIONS['geekbrains']} 

<blockquote>💡 <i>Подбуру самые лучшие курсы.</i></blockquote>
...
<blockquote>💡 <i>Для вас лучшая цена!
Мы даем только лучшие курсы.</i></blockquote>

#<b>Контакты:</b>
#По вопросам сотрудничества: @username

<i>Бот работает на энтузиазме ❤️</i>
    """
